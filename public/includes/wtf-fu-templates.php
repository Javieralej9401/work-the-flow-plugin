...
function getGalleryWidgetTemplate() {
...
function get_file_upload_form($action_href, $form_vars ) {

            $html = <<<EOUPLOADFILESHTML
<div class="panel-body tbs">
    <!-- The file upload form used as target for the file upload widget -->
    <form id="fileupload" action="$action_href" method="POST" enctype="multipart/form-data">
